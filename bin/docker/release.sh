...
# ======================================================================================================================
#
# docker/release - Wrapper script meant to make it easier to call the Docker version of the official release of the
...
mkdir -p $OUTPUT_DIR
docker run --rm -it -v $OUTPUT_DIR:/app/output/:rw ashelkov/owg:latest "${filtered_args[@]}"
